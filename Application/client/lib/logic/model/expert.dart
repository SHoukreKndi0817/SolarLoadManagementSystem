...
class LoginClient {
  ...
  LoginClient({this.msg, this.clientDate});

  LoginClient.fromJson(Map<String, dynamic> json) {
    msg = json['msg'];
    clientDate = json['client date'] != null
        ? new ClientDate.fromJson(json['client date'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.clientDate != null) {
      data['technicalexpert date'] = this.clientDate!.toJson();
    }
    return data;
  }
}
class ClientDate {
  ...
  ClientDate.fromJson(Map<String, dynamic> json) {
...
class ClientProfile {
  ...
  ClientProfile({this.msg, this.clientData});

  ClientProfile.fromJson(Map<String, dynamic> json) {
    msg = json['msg'];
    clientData = json['Client data'] != null
        ? new ClientData.fromJson(json['Client data'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.clientData != null) {
      data['Client data'] = this.clientData!.toJson();
    }
    return data;
  }
}
...
//////////////////////////////////////////////////////////////////////////////////////
class AllSolarSystem {
  String? msg;
  List<AllSolarSystemYouHave>? allSolarSystemYouHave;

  AllSolarSystem({this.msg, this.allSolarSystemYouHave});

  AllSolarSystem.fromJson(Map<String, dynamic> json) {
    msg = json['msg'];
    if (json['All Solar System You Have'] != null) {
      allSolarSystemYouHave = <AllSolarSystemYouHave>[];
      json['All Solar System You Have'].forEach((v) {
        allSolarSystemYouHave!.add(new AllSolarSystemYouHave.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['msg'] = this.msg;
    if (this.allSolarSystemYouHave != null) {
      data['All Solar System You Have'] =
          this.allSolarSystemYouHave!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class AllSolarSystemYouHave {
  int? solarSysInfoId;
  String? name;

  AllSolarSystemYouHave({this.solarSysInfoId, this.name});

  AllSolarSystemYouHave.fromJson(Map<String, dynamic> json) {
