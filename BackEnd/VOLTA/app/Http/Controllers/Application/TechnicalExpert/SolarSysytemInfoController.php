    ...
    public function AddSolarSystemInfo(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'battery_conection_type' => 'nullable|required_with:number_of_battery|in:12,24,36,48',
    ...
    public function UpdateSolarSystemInfo(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'battery_conection_type' => 'sometimes|nullable|required_with:number_of_battery|in:12,24,36,48',
